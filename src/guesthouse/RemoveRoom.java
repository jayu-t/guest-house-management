...
public class RemoveRoom extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int yn=JOptionPane.showConfirmDialog(null, "Are you sure. You want to remove room","Remove Room",JOptionPane.YES_NO_OPTION);
        if(yn==0) {
            int rno=Integer.parseInt(jTextField1.getText());
            GuestHouse db=new GuestHouse();
            db.removeRoom(rno);
            JOptionPane.showMessageDialog(null, "Sucessfully remove room", "Remove", JOptionPane.INFORMATION_MESSAGE);

...
public class CheckAvailability extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String cid=((JTextField)jDateChooser1.getDateEditor().getUiComponent()).getText();
        String cod=((JTextField)jDateChooser2.getDateEditor().getUiComponent()).getText();
        GuestHouse db=new GuestHouse();
        db.checkAvailability(type,cid,cod);

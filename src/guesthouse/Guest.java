...
public class Guest extends javax.swing.JFrame {
    ...
    public Guest(int rno,String cid,String cod){
        roomno=rno;
        checkId=cid;
        checkOd=cod;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Guest Entry Form");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        db.insertGuestData(name, address, contact, dob, gender, roomno, checkId, checkOd);
        JOptionPane.showMessageDialog(null, "Thanks Visiting us!\nYour room number is "+roomno, "Room Booked", JOptionPane.INFORMATION_MESSAGE);
    ...
    void setInfo(){
        String rno=String.valueOf(roomno);
        jTextField5.setText(rno);
        jTextField6.setText(checkId);
        jTextField7.setText(checkOd);
    }
